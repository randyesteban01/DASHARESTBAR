object frmSalidas: TfrmSalidas
  ...
  object QSalidas: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Salidas.SalidaID, Salidas.Fecha, Salidas.Concepto, Salida' +
        's.RealizadoID, '
      
        'ura.Nombre AS RealizadoPor, Salidas.RevisadoID, ure.Nombre AS Re' +
        'visadoPor,'
      
        ' Salidas.AutorizadoID, uau.Nombre AS AutorizadoPor,ExistenciaReb' +
        'ajada'
      'FROM Salidas '
      ...
      'order by ExistenciaRebajada desc, Salidas.SalidaID')
    Left = 240
    Top = 152
    ...
    object QSalidasRealizadoPor: TWideStringField
      FieldName = 'RealizadoPor'
      Size = 255
    end
    ...
    object QSalidasRevisadoPor: TWideStringField
      FieldName = 'RevisadoPor'
      Size = 255
    end
    ...
    object QSalidasAutorizadoPor: TWideStringField
      FieldName = 'AutorizadoPor'
      Size = 255
    end
    ...
    object QSalidasExistenciaRebajada: TBooleanField
      FieldName = 'ExistenciaRebajada'
    end
  end
