object frmBuscaFactura: TfrmBuscaFactura
  ...
  object QFactura: TADOQuery
    ...
    SQL.Strings = (
      ...
      'p.Autorizacion, p.Numero_Tarjeta, p.Banco, f.credito,'
      'f.tiponcf, f.mesaid'
      'from'
      'Factura_RestBar f, usuarios u, restbar_factura_forma_pago p'
      'where'
      'f.cajeroid = u.usu_codigo'
    ...
    object QFacturaCliente: TWideStringField
      FieldName = 'Cliente'
      Size = 255
    end
    ...
    object QFacturaForma: TWideStringField
      FieldName = 'Forma'
      Size = 255
    end
    ...
    object QFacturaDevuelta: TBCDField
      FieldName = 'Devuelta'
      currency = True
      Precision = 19
    end
    object QFacturatipo_Tarjeta: TWideStringField
      FieldName = 'tipo_Tarjeta'
      Size = 255
    end
    object QFacturaAutorizacion: TWideStringField
      FieldName = 'Autorizacion'
      Size = 255
    end
    object QFacturaNumero_Tarjeta: TWideStringField
      FieldName = 'Numero_Tarjeta'
      Size = 255
    end
    object QFacturaBanco: TWideStringField
      FieldName = 'Banco'
      Size = 255
    end
  ...
  object QForma: TADOQuery
    ...
    Left = 144
    Top = 272
    object QFormaCajeroID: TIntegerField
      FieldName = 'CajeroID'
    end
    object QFormaFacturaID: TIntegerField
      FieldName = 'FacturaID'
    end
    object QFormaCajaID: TIntegerField
      FieldName = 'CajaID'
    end
    object QFormaDetalleID: TIntegerField
      FieldName = 'DetalleID'
    end
    ...
    object QFormaTipo_Tarjeta: TWideStringField
      FieldName = 'Tipo_Tarjeta'
      Size = 255
    end
    object QFormaAutorizacion: TWideStringField
      FieldName = 'Autorizacion'
      Size = 255
    end
    object QFormaNumero_Tarjeta: TWideStringField
      FieldName = 'Numero_Tarjeta'
      Size = 255
    end
    object QFormaBanco: TWideStringField
      FieldName = 'Banco'
      Size = 255
    end
  end
  object QDetalle: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Visualizar, Imprimir, CajaID, Costo, MontoItbis'
      'from'
      'Factura_Items'
      'where'
      'CajeroID = :CajeroID'
    ...
    object QDetalleMontoItbis: TCurrencyField
  ...
  object QDetalleTotales: TADOQuery
    Connection = DM.ADOBar
    CursorType = ctStatic
    Filtered = True
    LockType = ltBatchOptimistic
    BeforeOpen = QDetalleTotalesBeforeOpen
    OnCalcFields = QDetalleCalcFields
    DataSource = dsVentas
    Parameters = <
      item
    ...
    SQL.Strings = (
        ...
        'select sum((Cantidad * Precio)-montoitbis) as subTotal,  sum(Des' +
        'cuento) as descuentoTotal'
      '  from Factura_Items'
      'where CajeroID = :CajeroID'
      '  and FacturaID = :FacturaID'
      '  and CajaID = :CajaID'
      'group by CajeroID, FacturaID, CajaID'
      '')
    Left = 112
    Top = 312
    object QDetalleTotalessubTotal: TFloatField
      FieldName = 'subTotal'
    end
    object QDetalleTotalesdescuentoTotal: TBCDField
