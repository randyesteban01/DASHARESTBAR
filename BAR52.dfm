object frmUnifMesa: TfrmUnifMesa
  Left = 399
  Top = 193
  BorderIcons = []
  ...
  object QFacturas: TADOQuery
    ...
    SQL.Strings = (
      'select'
        ...
        'f.FacturaID, f.Fecha, m.Nombre, f.Total, f.CajeroID, f.CajaID, t' +
        '.Unificada, f.MesaID'
      'from'
      'Factura f'
    ...
    object QFacturasUnificada: TIntegerField
      FieldName = 'Unificada'
    end
    object QFacturasMesaID: TIntegerField
      FieldName = 'MesaID'
    end
  end
