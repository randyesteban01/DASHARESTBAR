object frmConsVentas: TfrmConsVentas
  ...
  object QVentas: TADOQuery
    ...
    object QVentasForma: TWideStringField
      FieldName = 'Forma'
      Size = 255
    end
    object QVentasPagado: TBCDField
      FieldName = 'Pagado'
      currency = True
      Precision = 19
    end
    object QVentasDevuelta: TBCDField
      FieldName = 'Devuelta'
      currency = True
      Precision = 19
    end
    object QVentastipo_Tarjeta: TWideStringField
      FieldName = 'tipo_Tarjeta'
      Size = 255
    end
    object QVentasAutorizacion: TWideStringField
      FieldName = 'Autorizacion'
      Size = 255
    end
    object QVentasNumero_Tarjeta: TWideStringField
      FieldName = 'Numero_Tarjeta'
      Size = 255
    end
    object QVentasBanco: TWideStringField
      FieldName = 'Banco'
      Size = 255
    end
